...
import 'disput_center.dart';
import 'block_list.dart';
import 'language.dart';
import '../../authentication_screen/two_factor_auth_screen.dart';
          ...
          children: [
            ...
            Stack(
              ...
              children: [
                ...
                // Avatar Picture
                Positioned(
                  top: 130, // Positioning to overlap the header boundary
                  child: Container(
                    width: 100,
                    height: 100,
            ...
            // Name and Email
            const SizedBox(height: 60), // Spacer for the overlapping avatar
            Text(
              user?.username ?? "User",
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 60), // Padding for the bottom nav bar
                ],
              ),
            ),
          ],
